...
void main() => runApp(
      Directionality(
        ...
        child: new MaterialApp(
            debugShowCheckedModeBanner: false, home: new MainScreen()),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        RowOne('London', '22^', 'sunny',
            imageurl: 'http://cdn.onlinewebfonts.com/svg/img_272131.png'),
        Divider(
          color: Colors.black,
        ),
        RowTwo('one', 'two', 'three', 'fhor', 'five',
            ...
            imgprecipitation:
                'https://cdn.onlinewebfonts.com/svg/img_434060.png',
              ...
              Wrap(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Image.network(
                      'https://cdn.onlinewebfonts.com/svg/img_170346.png',
                      width: 60.0,
                      height: 60.0,
                    ),
                  ),
                  Container(
                    ...
                    child: GestureDetector(
                      ...
                      child: Image.network(
                        'https://cdn.onlinewebfonts.com/svg/img_115243.png',
                        width: 60.0,
                        height: 50.0,
                      ),
                    ),
...
class RowTwo extends StatelessWidget {
  ...
  RowTwo(this._humidity, this._precipitation, this._pressure, this._wind,
      this._direction,
      {String imghumidity,
      String imgprecipitation,
      String imgpressure,
      String imgwind,
      String imgdirection}) {
